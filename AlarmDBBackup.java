...
import com.pbn.boss.model.nms.meta.AlarmIfoConfig;
 ...
 */
public class DBBackupManagementController implements Controller
{

    static Logger logger = Logger.getLogger(DBBackupManagementController.class);
    ...
    public ModelAndView handleRequest(HttpServletRequest req, HttpServletResponse rep) throws Exception
    {
        ...
        AlarmIfoConfig dbMgr = null;
        BackupConfig dbBackup = null;
        Vector<BackupConfig> vector = null;
        ...
        if(action != null){
        	...
        	if(action.equals("getDBname")){
                ...
                dbMgr = new AlarmIfoConfig(nmscfg.getJT(), nmscfg.getDATABASETYPE());
                dbBackup = new BackupConfig();
                
                JSONArray jsonArr = new JSONArray();
                try
                {
                    vector = dbMgr.query("select * from backup_config");
                    ...
                    if(vector.size()>0){
                        ...
                        for(int i=0;i<vector.size();i++){
                            ...
                            dbBackup = (BackupConfig)vector.get(i);
                            
                            if(dbBackup != null){
                                
                                jsonObj.put("alarmtype", dbBackup.getAlarmtype());
                                jsonObj.put("time", dbBackup.getTime());
                                jsonObj.put("backupmode", dbBackup.getBackupmode());
            ...
            //and the backup type unique
                ...
                String backupmode = req.getParameter("backupmode");
                ...
                try
                {
                    vector = dbMgr.query("select * from backup_config where alarmtype = '" + alarmtype + "' and time = '" + time + "'");
                    ...
                    //dbBackup.setAlarmtype(Integer.parseInt(nmscfg.getSeqValue("BACKUPDB_ID")));
                    dbBackup.setTime(time);
                    dbBackup.setBackupmode(Integer.parseInt(backupmode));
                    dbBackup.setAlarmtype(alarmtype);
             ...
             //   String name = req.getParameter("name");
                ...
                try
                {
                 ...
                 //   dbBackup.setBackupType(Integer.parseInt(type));
                    dbBackup.setTime(time);
                    dbBackup.setBackupmode(Backupmode);
        	...
        	/*else if(action.equals("deleteBackup")){
                ...
                try
                {
                    dbBackup.setAlarmtype(Integer.parseInt(alarmtype));
            ...
            //manual backup
                ...
                try
                {
                    ...
                    agents = agentInfoMgr.query("select * from alarm_history");
  ...
  */      
        ModelAndView mv = new ModelAndView("system/alarmbackup");
